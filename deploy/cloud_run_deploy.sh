...
PROJECT_ID="${GCP_PROJECT_ID:-materials-resilience-agent}"
REGION="us-central1"
SERVICE="matres"
...
gcloud run deploy "${SERVICE}" \
  ...
  --set-secrets "GEMINI_API_KEY=GEMINI_API_KEY:latest,MATERIALS_PROJECT_API_KEY=MATERIALS_PROJECT_API_KEY:latest" \
  --project "${PROJECT_ID}"
